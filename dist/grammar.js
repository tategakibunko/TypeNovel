...
const grammar = {
    ...
    ParserRules: [
        ...
        { "name": "plain", "symbols": ["text"], "postprocess": (d) => {
        ...
        { "name": "annot", "symbols": [(lexer.has("annotStart") ? { type: "annotStart" } : annotStart), (lexer.has("annotName") ? { type: "annotName" } : annotName), "args"], "postprocess": (d) => {
                const codePos = {
                    startLine: d[0].line - 1,
                    endLine: d[0].line - 1,
                    startColumn: d[0].col - 1,
        ...
        { "name": "block", "symbols": [(lexer.has("blockStart") ? { type: "blockStart" } : blockStart), (lexer.has("blockName") ? { type: "blockName" } : blockName), "args", "block$ebnf$1", (lexer.has("blockTextStart") ? { type: "blockTextStart" } : blockTextStart), "block$ebnf$2", (lexer.has("blockTextEnd") ? { type: "blockTextEnd" } : blockTextEnd)], "postprocess": (d) => {
                const codePos = {
                    startLine: d[0].line - 1,
                    endLine: d[6].line - 1,
                    startColumn: d[0].col - 1,
        ...
        { "name": "text", "symbols": [(lexer.has("escape") ? { type: "escape" } : escape)], "postprocess": (d) => {
